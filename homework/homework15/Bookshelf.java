package com.proftelran.homework.homework15;

import com.proftelran.homework.homework10.*;
...
public class Bookshelf {
        public static void main (String[]args){
            ...
            com.proftelran.homework.homework10.Book bookOne = new Book("Gone with the Wind", "Margaret Mitchell",
                    300, 1936, "Unknown");
            com.proftelran.homework.homework10.Book bookTwo = new Book("Martin Eden", "Jack London",
                    399, 1909, "World of literature");
            com.proftelran.homework.homework10.Book bookThree = new Book("The Memoirs of Sherlock Holmes", "Arthur Conan Doyle",
                    276, 1894, "Detectives");
            com.proftelran.homework.homework10.Book bookFour = new Book("Pride and Prejudice", "Jane Austen",
                    327, 1796, "Love Stories");
            com.proftelran.homework.homework10.Book bookFive = new Book("The Picture of Dorian Gray", "Oscar Wilde",
                    187, 1890, "Mystery");
            com.proftelran.homework.homework10.Book bookSix = new com.proftelran.homework.homework10.Book("Death on the Nile", "Agatha Christie",
                    199, 1937, "Detective House");
            com.proftelran.homework.homework10.Book bookSeven = new com.proftelran.homework.homework10.Book("The Silence of the Lambs", "Thomas Harris",
                    352, 1988, "Horror");
